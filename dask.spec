...
Source0  : https://files.pythonhosted.org/packages/5e/90/4d10879156b5e6c90f57690e05041407ab133e5a0435dd3c10c0420ffa80/dask-2.8.0.tar.gz
...
%prep
%setup -q -n dask-2.8.0
cd %{_builddir}/dask-2.8.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573790469
...
cp %{_builddir}/dask-2.8.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/98e42a13a272323dc03ebff615190ec2dba9c484
