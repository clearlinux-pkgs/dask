...
%prep
%setup -q -n dask-2.8.1
cd %{_builddir}/dask-2.8.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574693772
...
cp %{_builddir}/dask-2.8.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/98e42a13a272323dc03ebff615190ec2dba9c484
