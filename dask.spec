...
Version  : 0.14.1
Release  : 3
URL      : http://pypi.debian.net/dask/dask-0.14.1.tar.gz
Source0  : http://pypi.debian.net/dask/dask-0.14.1.tar.gz
...
%prep
%setup -q -n dask-0.14.1

%build
export LANG=C
export SOURCE_DATE_EPOCH=1490213072
