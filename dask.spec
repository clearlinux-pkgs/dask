...
Version  : 2.22.0
Release  : 95
URL      : https://files.pythonhosted.org/packages/d7/a7/831ebf7dc8a4ed8fed72cb3590bbcca5869b769db835ed23c5f9d20bf889/dask-2.22.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/d7/a7/831ebf7dc8a4ed8fed72cb3590bbcca5869b769db835ed23c5f9d20bf889/dask-2.22.0.tar.gz
...
%prep
%setup -q -n dask-2.22.0
cd %{_builddir}/dask-2.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1596467284
...
cp %{_builddir}/dask-2.22.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/98e42a13a272323dc03ebff615190ec2dba9c484
