...
Version  : 2.28.0
Release  : 102
URL      : https://files.pythonhosted.org/packages/53/4c/cf01ab8aac27c81431e70dc1a2ae99d11d8883ef7452820672967605da52/dask-2.28.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/53/4c/cf01ab8aac27c81431e70dc1a2ae99d11d8883ef7452820672967605da52/dask-2.28.0.tar.gz
...
%prep
%setup -q -n dask-2.28.0
cd %{_builddir}/dask-2.28.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601311907
...
cp %{_builddir}/dask-2.28.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/11121adb6817476c9a2f348de0b254ca5df12057
