...
Version  : 2.9.0
Release  : 74
URL      : https://files.pythonhosted.org/packages/31/91/eb2175a031669b79042e1db62d1d0671a6b7f58daad8db9221827a073a1d/dask-2.9.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/31/91/eb2175a031669b79042e1db62d1d0671a6b7f58daad8db9221827a073a1d/dask-2.9.0.tar.gz
...
%prep
%setup -q -n dask-2.9.0
cd %{_builddir}/dask-2.9.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1575785751
...
cp %{_builddir}/dask-2.9.0/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/98e42a13a272323dc03ebff615190ec2dba9c484
