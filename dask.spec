...
%prep
%setup -q -n dask-2021.6.2
cd %{_builddir}/dask-2021.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624459156
...
cp %{_builddir}/dask-2021.6.2/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/11121adb6817476c9a2f348de0b254ca5df12057
