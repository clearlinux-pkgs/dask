...
Version  : 2021.1.1
Release  : 110
URL      : https://files.pythonhosted.org/packages/ff/d7/469d718217307e8182092cd6985d1efaea08f100092600517336cd1419a4/dask-2021.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/ff/d7/469d718217307e8182092cd6985d1efaea08f100092600517336cd1419a4/dask-2021.1.1.tar.gz
...
%prep
%setup -q -n dask-2021.1.1
cd %{_builddir}/dask-2021.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611424467
...
cp %{_builddir}/dask-2021.1.1/LICENSE.txt %{buildroot}/usr/share/package-licenses/dask/11121adb6817476c9a2f348de0b254ca5df12057
